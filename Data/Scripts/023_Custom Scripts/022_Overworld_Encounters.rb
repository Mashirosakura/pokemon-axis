#===============================================================================
# * Visible Overworld Encounters V2.0.3 for PEv18 - by derFischae (Credits if used please) *
#===============================================================================
#
...
def pbModWildBattle(vsT, vsO, species1, level1, species2 = nil, level2 = nil,
                  ...
                  outcomeVar=1, canRun=true, canLose=false,
                  gender1 = nil, gender2 = nil, gender3 = nil, gender4 = nil,
                  form1 = nil,shinysprite1 = nil,form2 = nil,shinysprite2 = nil,
                  form3 = nil,shinysprite3 = nil,form4 = nil,shinysprite4 = nil)
  # Set some battle rules
  setBattleRule("outcomeVar",outcomeVar) if outcomeVar!=1
  ...
  # Perform the battle
  if vsO==1
  decision = pbWildBattleCore([species1,level1,gender1,form1,shinysprite1])
  elsif vsO==2
  decision = pbWildBattleCore([species1,level1,gender1,form1,shinysprite1],[species2,level2,gender2,form2,shinysprite2])
  elsif vsO==3
  decision = pbWildBattleCore([species1,level1,gender1,form1,shinysprite1],[species2,level2,gender2,form2,shinysprite2],[species3,level3,gender3,form3,shinysprite3])
  elsif vsO==4
  decision = pbWildBattleCore([species1,level1,gender1,form1,shinysprite1],[species2,level2,gender2,form2,shinysprite2],[species3,level3,gender3,form3,shinysprite3],[species4,level4,gender4,form4,shinysprite4])
  end
  # Return false if the player lost or drew the battle, and true if any other result
  return (decision!=2 && decision!=5)
end